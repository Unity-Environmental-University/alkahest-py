...
Pick a focus from set_of_support, combine it with everything in usable,
add new results back to set_of_support. The combination function is
entirely pluggable — this loop knows nothing about what the items mean.
"""
