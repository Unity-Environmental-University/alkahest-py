...
Extracted from otter-centaur. These are the atoms —
nothing here depends on inference rules, domains, or combination strategies.
"""
...
@dataclass
class Clause:
    """A disjunction of literals for resolution domains."""
    literals: frozenset
    source: tuple = ()
    step: int = 0
    label: str = ""
